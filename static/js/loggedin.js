"use strict";
{
    ...
    function delete_all_selected_lessons_from_db(lessons) {
        let xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                console.log("Response Type " + this.responseType);
    ...
    // GUI Stuff
    function add_new_lesson_to_lesson_list(lesson_list, new_lesson) {
    ...
    function set_up_lesson_list(lessons) {
